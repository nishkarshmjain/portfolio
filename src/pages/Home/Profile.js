...
const ProfileText = ({ status, titleId }) => (
  <Fragment>
    ...
    <Text
      ...
      size="l"
    >
      I’m Nishkarsh. Currently, I am based in Pune, working as the Software Engineer at{' '}
      <Link href="https://www.linkedin.com/company/accenture/" target="_blank">Accenture</Link>
      . I am a Data Scientist, Travel Blogger, and a Writer.
    </Text>
    <Text
      className={classNames('profile__description', `profile__description--${status}`)}
      size="l"
    >
      In my spare time, I like to write and{' '}
